# Simple Python HTTPS Web Server for 2A Toolbox Arsenal Management System
...
def generate_self_signed_cert():
    ...
    subject = issuer = x509.Name([
        ...
        x509.NameAttribute(NameOID.ORGANIZATION_NAME, "2A Toolbox Arsenal Management System"),
